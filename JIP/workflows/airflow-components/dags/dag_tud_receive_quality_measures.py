...
dag = DAG(
    dag_id='tuda_receive-quality-measures',
    default_args=args,
...
send_to_dashboard = SendDataToWebDashboardOperator(dag=dag, input_operator=dcm_to_json, command="sendQualityMeasures", dashboard_web_host="http://192.168.178.93", dashboard_web_port="8001", dashboard_api_token="cef4d40440c2411a22fe5635c54ee8501b4bfe53")
