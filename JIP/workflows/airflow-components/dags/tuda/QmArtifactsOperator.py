...
class QmArtifactsOperator(KaapanaBaseOperator):
    ...
    def __init__(self,
        ...
        super().__init__(
            dag=dag,
            image="{}{}/publictest:qm_amin_1".format(my_registry, my_project),  # Image from docker container /processing-container/qm_artifacts
            name=f'qm-artifacts',
            env_vars=env_vars,
