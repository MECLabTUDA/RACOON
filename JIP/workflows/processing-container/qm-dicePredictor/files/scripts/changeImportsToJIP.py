...
def changeImportsToJIP(codeDirectory, importTexts, importReplacemts):
...
if __name__ == '__main__':
    ...
    importTexts = ['import os', 'import SimpleITK as sitk']  # Change accordingly
    importReplacemts = ['import JIP.osp', 'import JIP.SimpleITK as sitk']  # Change accordingly
    # 'import os' will be changed in each file to 'import JIP.osp'
    changeImportsToJIP(codeDirectory, importTexts, importReplacemts)
