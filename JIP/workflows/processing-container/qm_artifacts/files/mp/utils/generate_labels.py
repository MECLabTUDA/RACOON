...
def generate_labels(num_intensities, source_path, target_path):
    ...
    labels['GC_Corona_volume-covid19-A-0196'+'_resolution'] = 5/num_intensities
    ...
    labels['GC_Corona_volume-covid19-A-0202'+'_resolution'] = 5/num_intensities
    ...
    labels['GC_Corona_volume-covid19-A-0383'+'_resolution'] = 5/num_intensities
